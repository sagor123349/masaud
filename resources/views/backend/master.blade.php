...
<head>
    ...
    <title>MS| Dashboard</title><!--begin::Primary Meta Tags-->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    ...
    @csrf
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="./index.html" class="brand-link"> <!--begin::Brand Image--> <span class="brand-text fw-light">MS</span> <!--end::Brand Text--> </a> <!--end::Brand Link--> </div> <!--end::Sidebar Brand--> <!--begin::Sidebar Wrapper-->
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="{{route('dashboard')}}" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="{{route('dashboard')}}" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>MS</p>
                                    </a> </li>
                                ...
                                <li class="nav-item"> <a href="{{route('frontend.fashion')}}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Shoping</p>
                                    </a> </li>
                            </ul>
                        </li>
        ...
        <footer class="app-footer"> <!--begin::To the end-->
            <div class="float-end d-none d-sm-inline">Anything you want</div> <!--end::To the end--> <!--begin::Copyright--> <strong>
                ...
                <a href="#" class="text-decoration-none">MS</a>.
            </strong>
            All rights reserved.
            <!--end::Copyright-->
